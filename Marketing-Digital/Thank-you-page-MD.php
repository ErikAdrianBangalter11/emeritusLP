...
<body class="altura-auto">
  ...
  <div class="c-thank-desk">
    <div class="logo"><a href="https://latam.emeritus.org/programas/Marketing-Digital/" target="_blank"><img src="../assets/img/svg/emeritus-logo-complete-TYP.svg"
          alt=""></a></div>
    <div class="c-thank-cont">
      ...
      <div class="c-thank-tittles">
        ...
        <div class="text-tittle-sub fs22">Gracias por tu interés en el programa
          <br><strong>"Marketing Digital: Redes sociales, lealtad, planeación y analítica"</strong></div>
      </div>
      <div class="c-button-link">
        <div class="button-text fs18">Si tu descarga no comienza,</div><a target="_blank" href="http://bit.ly/2IZ7mOJ"
          download="Folleto-Digital_Marketing-CBS" class="btn-link w-button fs18" id="download">da clic aquí</a>
      </div>
      <div class="thank-line"></div>
      <div class="button-thank-tittle fs34">¿Listo para el próximo paso?</div><a href="http://bit.ly/2ubwV9V" class="btn-thank fs20 w-button"
        id="btn-apply-now">Llena la solicitud</a>
    </div>
    <div class="c-thank-footer-desk">
      <div class="thank-footer-tittle">Conéctate con nosotros</div>
      <div class="thank-footer-icons">
        <div class="footer-icon"> <a target="_blank" href="https://www.facebook.com/EMERITUS.INST/"><img src="../assets/img/svg/facebook.svg"></a>
        </div>
        <div class="footer-icon"> <a target="_blank" href="https://twitter.com/EMERITUS_INST"><img src="../assets/img/svg/twitter.svg"></a></div>
        <div class="footer-icon"> <a target="_blank" href="https://www.linkedin.com/school/emeritus-institute-of-management/"><img
              src="../assets/img/svg/linkedin-circle.svg"></a></div>
      </div>
    </div>
  </div>
